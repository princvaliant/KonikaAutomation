...
namespace KonikaGlo
{
    ...
    public class CL
    {
        ...
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = (CL.MAXDATAROW * CL.MAXDATACOL - 1))]
            public float[] X;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = (CL.MAXDATAROW * CL.MAXDATACOL - 1))]
            public float[] Y;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = (CL.MAXDATAROW * CL.MAXDATACOL - 1))]
        ...
        [DllImport("CA2DSDK.dll", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
        //Get the data
        public static extern int CA2DSDK_GetAreaData(ref tagGetDataParam pDataParam,  float[] pData);
        [DllImport("CA2DSDK.dll", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
